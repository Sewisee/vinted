        ...
        vinted.search(sub.url, false, false, {
            ...
            for (let item of itemsToSend) {
                const embed = new Discord.MessageEmbed()
                    .setTitle('**:technologist: VINTED MONITOR**')
                    ...
                    .setFooter('Powered by Francify')
                    .addField('Nom du produit', item.title || 'vide', false)
...
client.on('ready', () => {
    ...
    client.user.setActivity(`gerer Francify`); //| v${version}
});
...
function getReputationStars(reputationPercent) {
    ...
    var reputDemiCalc = reputationPercent % 0.2;
    var starsStr = '';
    for (var i = 0; i < reputCalc; i++) {
        starsStr += ':star:';
    }
